...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_StartScene_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_StartScene_t qt_meta_stringdata_StartScene = {
    {
QT_MOC_LITERAL(0, 0, 10) // "StartScene"
...
const QMetaObject StartScene::staticMetaObject = {
    { &MyMainWindow::staticMetaObject, qt_meta_stringdata_StartScene.data,
      qt_meta_data_StartScene,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *StartScene::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StartScene.stringdata0))
        return static_cast<void*>(const_cast< StartScene*>(this));
    return MyMainWindow::qt_metacast(_clname);
}

int StartScene::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = MyMainWindow::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
