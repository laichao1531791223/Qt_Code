...
QT_MOC_LITERAL(1, 10, 14), // "backBtnClicked"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "PlayScene\0backBtnClicked\0"
};
...
void PlayScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PlayScene::backBtnClicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject PlayScene::staticMetaObject = {
    { &MyMainWindow::staticMetaObject, qt_meta_stringdata_PlayScene.data,
